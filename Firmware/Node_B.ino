...
const char *NODE_ID = "NODE_B"; // <-- MUST BE NODE_B!
...
void setup() {
  ...
  Serial.println("=== NODE_B STARTING ===");
...
void loop() {
  ...
  if (millis() - lastHeartbeat > 10000) {
    String hb = "{\"type\":\"heartbeat\",\"id\":\"NODE_B\",\"uptime\":";
